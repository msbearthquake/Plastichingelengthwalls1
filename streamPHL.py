...
filename1 = dirname + '/Capture1.png'
filename2 = dirname + '/Capture2.png'
...
filename3 = dirname + '/finalized_model.sav'
...
filename4 = dirname + '/Capture3.png'
filename5 = dirname + '/Capture4.png'
